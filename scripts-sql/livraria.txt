...
CONSTRAINT [FK_Emprestimo_Livro] FOREIGN KEY ([LivroId]) REFERENCES
Livro(LivroId),
CONSTRAINT [FK_Emprestimo_Aluno] FOREIGN KEY ([Matricula]) REFERENCES
Aluno(Matricula)
);
...
VALUES (1, 'Introdução aos Fundamentos da Computação', 'Newton José Vieira', 'ISBN
123456', 10);
...
UPDATE Emprestimo SET DataHora_Emprestimo = '2023-07-08 22:00:00' WHERE
EmprestimoId = 1;
-- DELETE
