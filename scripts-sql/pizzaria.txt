...
CONSTRAINT [FK_PEDIDO_COMPRA] FOREIGN KEY ([COD_PEDIDO_COMPRA]) REFERENCES
...
CONSTRAINT [FK_SITUACAO_PEDIDO] FOREIGN KEY ([COD_SITUACAO_PEDIDO])
REFERENCES SITUACAO_PEDIDO(COD_SITUACAO_PEDIDO),
...
CONSTRAINT [FK_PEDIDO_VENDA] FOREIGN KEY ([COD_PEDIDO_VENDA]) REFERENCES
PEDIDO_COMPRA(COD_PEDIDO_COMPRA),
CONSTRAINT [FK_PRODUTO] FOREIGN KEY ([COD_PRODUTO]) REFERENCES
PRODUTO(COD_PRODUTO)
);
...
INSERT INTO PRODUTO (COD_PRODUTO, COD_TIPO_PRODUTO, NOME, VLR_PRODUTO_COMPRA,
VLR_PRODUTO_VENDA)
