...
[COD_MATRICULA] INTEGER NOT NULL,
[COD_DISCIPLINA] INTEGER NOT NULL,
CONSTRAINT [PK_DISCIPLINAS_MATRICULA] PRIMARY KEY
([COD_DISCIPLINAS_MATRICULA]),
CONSTRAINT [FK_MATRICULA] FOREIGN KEY ([COD_MATRICULA]) REFERENCES
MATRICULA(COD_MATRICULA),
CONSTRAINT [FK_DISCIPLINA] FOREIGN KEY ([COD_DISCIPLINA]) REFERENCES
DISCIPLINA(COD_DISCIPLINA)
);
CREATE UNIQUE INDEX [IPK_DISCIPLINAS_MATRICULA] ON [DISCIPLINAS_MATRICULA]
([COD_DISCIPLINAS_MATRICULA]);
...
CREATE UNIQUE INDEX [IPK_CURSOS_MATRICULA] ON [CURSOS_MATRICULA]
([COD_CURSOS_MATRICULA]);
...
CONSTRAINT [FK_PROFESSOR] FOREIGN KEY ([COD_PROFESSOR]) REFERENCES
PROFESSOR(COD_PROFESSOR),
CONSTRAINT [FK_DISCIPLINA] FOREIGN KEY ([COD_DISCIPLINA]) REFERENCES
DISCIPLINA(COD_DISCIPLINA)
);
CREATE UNIQUE INDEX [IPK_DISCIPLINAS_PROFESSOR] ON [DISCIPLINAS_PROFESSOR]
([COD_DISCIPLINAS_PROF]);
