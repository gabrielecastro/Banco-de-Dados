...
-- Criando a tabela pontos turísticos
...
CREATE UNIQUE INDEX [IPK_PONTOS_TURISTICOS] ON [PONTOS_TURISTICOS]
([COD_PONTO_TURISTICO]);
...
CONSTRAINT [FK_PARQUE] FOREIGN KEY ([COD_PARQUE]) REFERENCES
PARQUE(COD_PARQUE),
CONSTRAINT [FK_VISITANTE] FOREIGN KEY ([COD_VISITANTE]) REFERENCES
...
CONSTRAINT [FK_VISITA] FOREIGN KEY ([COD_VISITA]) REFERENCES
VISITA(COD_VISITA),
CONSTRAINT [FK_PONTO_TURISTICO] FOREIGN KEY ([COD_PONTO_TURISTICO])
REFERENCES PONTO_TURISTICO(COD_PONTO_TURISTICO)
);
