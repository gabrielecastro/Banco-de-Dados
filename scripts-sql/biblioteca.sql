...
CONSTRAINT [FK_ASSUNTO] FOREIGN KEY ([COD_ASSUNTO]) REFERENCES
ASSUNTO(COD_ASSUNTO),
CONSTRAINT [FK_GENERO] FOREIGN KEY ([COD_GENERO]) REFERENCES
GENERO(COD_GENERO)
);
...
CONSTRAINT [FK_EMPRESTIMO] FOREIGN KEY ([COD_EMPRESTIMO]) REFERENCES
EMPRESTIMO(COD_EMPRESTIMO),
CONSTRAINT [FK_LIVRO] FOREIGN KEY ([COD_LIVRO]) REFERENCES LIVRO(COD_LIVRO)
);
CREATE UNIQUE INDEX [IPK_LIVROS_EMPRESTIMO] ON [LIVROS_EMPRESTIMO]
([COD_LIVROS_EMPRESTIMO]);
...
CONSTRAINT [PK_EXEMPLARES_EMPRESTIMO] PRIMARY KEY
([COD_EXEMPLARES_EMPRESTIMO]),
CONSTRAINT [FK_LIVROS_EMPRESTIMO] FOREIGN KEY ([COD_LIVROS_EMPRESTIMO])
REFERENCES LIVROS_EMPRESTIMO(COD_LIVROS_EMPRESTIMO)
);
CREATE UNIQUE INDEX [IPK_EXEMPLARES_EMPRESTIMO] ON [EXEMPLARES_EMPRESTIMO]
([COD_EXEMPLARES_EMPRESTIMO]);
