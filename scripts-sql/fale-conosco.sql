...
CREATE UNIQUE INDEX [IPK_TIPO_COMUNICADO] ON [TIPO_COMUNICADO]
([COD_TIPO_COMUNICADO]);
...
USUARIO(COD_USUARIO),
CONSTRAINT [FK_LOTACAO] FOREIGN KEY ([COD_LOTACAO]) REFERENCES
LOTACAO(COD_LOTACAO)
);
...
CONSTRAINT [FK_TIPO_COMUNICADO] FOREIGN KEY ([COD_TIPO_COMUNICADO]) REFERENCES
TIPO_COMUNICADO(COD_TIPO_COMUNICADO)
);
