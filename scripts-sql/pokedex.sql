...
(`ID_Pokemon` int not null, `Pokemon` varchar(11), `HP` int, `Attack` int,
`Defense` int, `Special_Attack` int, `Special_Defense` int, `Speed` int, PRIMARY
KEY (ID_Pokemon))
;
INSERT INTO Pokemon
(`ID_Pokemon`, `Pokemon`, `HP`, `Attack`, `Defense`, `Special_Attack`,
...
(`ID_Trainer` int not null, `Trainer` varchar(11), `Badges` int, PRIMARY
KEY(ID_Trainer))
;
